...
func (c *addServiceClient) Array(ctx context.Context, in *ArrayRequest, opts ...grpc.CallOption) (*ArrayResponse, error) {
...
func (UnimplementedAddServiceServer) Array(context.Context, *ArrayRequest) (*ArrayResponse, error) {
...
func _AddService_Array_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Array(ctx, req.(*ArrayRequest))
	}
	return interceptor(ctx, in, info, handler)
}
